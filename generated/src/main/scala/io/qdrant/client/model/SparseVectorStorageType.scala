...
enum SparseVectorStorageType:
  case `on_disk`
  case `mmap`

object SparseVectorStorageType:
  import com.github.plokhotnyuk.jsoniter_scala.macros.*
  import com.github.plokhotnyuk.jsoniter_scala.core.*
  given sparseVectorStorageTypeCodec: JsonValueCodec[SparseVectorStorageType] = JsonCodecMaker.make {
    CodecMakerConfig
      .withAdtLeafClassNameMapper { x =>
        JsonCodecMaker.simpleClassName(x) match
          case "on_disk" => "on_disk"
          case "mmap" => "mmap"
      }
      .withDiscriminatorFieldName(scala.None)
  }
end SparseVectorStorageType
