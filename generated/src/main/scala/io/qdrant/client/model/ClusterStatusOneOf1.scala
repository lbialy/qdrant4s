...
case class ClusterStatusOneOf1(
  @named("status") status: ClusterStatusOneOf1Enums.Status,
  /* ID of this peer */
  @named("peer_id") peerId: Long,
  /* Peers composition of the cluster with main information */
  @named("peers") peers: Map[String, PeerInfo],
  @named("raft_info") raftInfo: RaftInfo,
  ...
  @named("message_send_failures") messageSendFailures: Map[String, MessageSendErrors]
)

object ClusterStatusOneOf1Enums:
  enum Status:
    case `enabled`
