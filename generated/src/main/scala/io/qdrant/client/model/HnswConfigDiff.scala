...
case class HnswConfigDiff(
  /* Number of edges per node in the index graph. Larger the value - more accurate the search, more space required. */
  @named("m") m: Option[Int] = scala.None,
  /* Number of neighbours to consider during the index building. Larger the value - more accurate the search, more time required to build the index. */
  @named("ef_construct") efConstruct: Option[Int] = scala.None,
  ...
  @named("full_scan_threshold") fullScanThreshold: Option[Int] = scala.None,
  ...
  @named("max_indexing_threads") maxIndexingThreads: Option[Int] = scala.None,
  ...
  @named("payload_m") payloadM: Option[Int] = scala.None,
  ...
  @named("inline_storage") inlineStorage: Option[Boolean] = scala.None
)
