...
case class TrackerTelemetry(
  ...
  @named("segment_ids") segmentIds: Seq[Int],
  ...
  @named("segment_uuids") segmentUuids: Seq[UUID],
  @named("status") status: TrackerStatus,
  /* Start time of the optimizer */
  @named("start_at") startAt: OffsetDateTime,
  /* End time of the optimizer */
  @named("end_at") endAt: Option[OffsetDateTime] = scala.None
)
