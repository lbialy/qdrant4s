...
case class PayloadStorageTypeOneOf2(
  @named("type") `type`: PayloadStorageTypeOneOf2Enums.Type
)

object PayloadStorageTypeOneOf2Enums:
  enum Type:
    case `mmap`
...
end PayloadStorageTypeOneOf2Enums
