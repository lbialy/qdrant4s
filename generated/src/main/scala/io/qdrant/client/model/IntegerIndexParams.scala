...
import io.qdrant.client.model.IntegerIndexType.*
import com.github.plokhotnyuk.jsoniter_scala.macros.named



case class IntegerIndexParams(
  @named("type") `type`: IntegerIndexType,
  /* If true - support direct lookups. Default is true. */
  @named("lookup") lookup: Option[Boolean] = scala.None,
  /* If true - support ranges filters. Default is true. */
  @named("range") range: Option[Boolean] = scala.None,
  ...
  @named("is_principal") isPrincipal: Option[Boolean] = scala.None,
...
object IntegerIndexParamsEnums:
end IntegerIndexParamsEnums
