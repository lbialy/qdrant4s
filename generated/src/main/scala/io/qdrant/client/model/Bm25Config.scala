...
case class Bm25Config(
  ...
  @named("b") b: Option[Double] = scala.None,
  /* Expected average document length in the collection. Default is 256. */
  @named("avg_len") avgLen: Option[Double] = scala.None,
