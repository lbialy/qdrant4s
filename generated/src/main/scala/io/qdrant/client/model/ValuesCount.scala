...
case class ValuesCount(
  /* point.key.length() < values_count.lt */
  @named("lt") lt: Option[Int] = scala.None,
  /* point.key.length() > values_count.gt */
  @named("gt") gt: Option[Int] = scala.None,
  /* point.key.length() >= values_count.gte */
  @named("gte") gte: Option[Int] = scala.None,
  /* point.key.length() <= values_count.lte */
  @named("lte") lte: Option[Int] = scala.None
)
