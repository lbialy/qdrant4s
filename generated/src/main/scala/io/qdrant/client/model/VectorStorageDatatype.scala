...
enum VectorStorageDatatype:
  case `float32`
  case `float16`
  case `uint8`

object VectorStorageDatatype:
  import com.github.plokhotnyuk.jsoniter_scala.macros.*
  import com.github.plokhotnyuk.jsoniter_scala.core.*
  given vectorStorageDatatypeCodec: JsonValueCodec[VectorStorageDatatype] = JsonCodecMaker.make {
    CodecMakerConfig
