...
object BinaryQuantizationQueryEncoding:
  import com.github.plokhotnyuk.jsoniter_scala.macros.*
  import com.github.plokhotnyuk.jsoniter_scala.core.*
  given binaryQuantizationQueryEncodingCodec: JsonValueCodec[BinaryQuantizationQueryEncoding] = JsonCodecMaker.make {
    CodecMakerConfig
      .withAdtLeafClassNameMapper { x =>
        JsonCodecMaker.simpleClassName(x) match
          case "default" => "default"
          case "binary" => "binary"
          case "scalar4bits" => "scalar4bits"
          case "scalar8bits" => "scalar8bits"
      }
      .withDiscriminatorFieldName(scala.None)
  }
end BinaryQuantizationQueryEncoding
