...
enum VectorStorageType:
  ...
  case `Mmap`
  case `ChunkedMmap`
  case `InRamChunkedMmap`
  case `InRamMmap`

object VectorStorageType:
  import com.github.plokhotnyuk.jsoniter_scala.macros.*
  import com.github.plokhotnyuk.jsoniter_scala.core.*
  given vectorStorageTypeCodec: JsonValueCodec[VectorStorageType] = JsonCodecMaker.make {
    CodecMakerConfig
      .withAdtLeafClassNameMapper { x =>
        JsonCodecMaker.simpleClassName(x) match
          ...
          case "InRamChunkedMmap" => "InRamChunkedMmap"
          case "InRamMmap" => "InRamMmap"
      }
      .withDiscriminatorFieldName(scala.None)
  }
end VectorStorageType
