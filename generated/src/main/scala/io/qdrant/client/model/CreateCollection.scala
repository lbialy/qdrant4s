...
import io.qdrant.client.model.ShardingMethod.*
...
case class CreateCollection(
  @named("vectors") vectors: Option[VectorsConfig] = scala.None,
  ...
  @named("shard_number") shardNumber: Option[Int] = scala.None,
  @named("sharding_method") shardingMethod: Option[ShardingMethod] = scala.None,
  /* Number of shards replicas. Default is 1 Minimum is 1 */
  @named("replication_factor") replicationFactor: Option[Int] = scala.None,
  ...
  @named("write_consistency_factor") writeConsistencyFactor: Option[Int] = scala.None,
  ...
  @named("on_disk_payload") onDiskPayload: Option[Boolean] = scala.None,
  @named("hnsw_config") hnswConfig: Option[HnswConfigDiff] = scala.None,
  @named("wal_config") walConfig: Option[WalConfigDiff] = scala.None,
  @named("optimizers_config") optimizersConfig: Option[OptimizersConfigDiff] = scala.None,
  @named("quantization_config") quantizationConfig: Option[QuantizationConfig] = scala.None,
  /* Sparse vector data config. */
  @named("sparse_vectors") sparseVectors: Option[Map[String, SparseVectorParams]] = scala.None,
  @named("strict_mode_config") strictModeConfig: Option[StrictModeConfig] = scala.None,
  @named("metadata") metadata: Option[Map[String, io.circe.Json]] = scala.None
)

object CreateCollectionEnums:
end CreateCollectionEnums
