...
enum ShardTransferMethod:
  ...
  case `snapshot`
  case `wal_delta`
  case `resharding_stream_records`

object ShardTransferMethod:
  import com.github.plokhotnyuk.jsoniter_scala.macros.*
  import com.github.plokhotnyuk.jsoniter_scala.core.*
  given shardTransferMethodCodec: JsonValueCodec[ShardTransferMethod] = JsonCodecMaker.make {
    CodecMakerConfig
      .withAdtLeafClassNameMapper { x =>
        JsonCodecMaker.simpleClassName(x) match
          case "stream_records" => "stream_records"
          case "snapshot" => "snapshot"
          case "wal_delta" => "wal_delta"
          case "resharding_stream_records" => "resharding_stream_records"
      }
      .withDiscriminatorFieldName(scala.None)
  }
end ShardTransferMethod
