...
case class OptimizationsSummary(
  ...
  @named("queued_optimizations") queuedOptimizations: Int,
  /* Number of unoptimized segments in the queue. */
  @named("queued_segments") queuedSegments: Int,
  /* Number of points in unoptimized segments in the queue. */
  @named("queued_points") queuedPoints: Int,
  /* Number of segments that don't require optimization. */
  @named("idle_segments") idleSegments: Int
)
