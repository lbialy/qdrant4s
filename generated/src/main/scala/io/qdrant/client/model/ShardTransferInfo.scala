...
import io.qdrant.client.model.ShardTransferMethod.*
import com.github.plokhotnyuk.jsoniter_scala.macros.named



case class ShardTransferInfo(
  @named("shard_id") shardId: Int,
  /* Target shard ID if different than source shard ID  Used exclusively with `ReshardingStreamRecords` transfer method. */
  @named("to_shard_id") toShardId: Option[Int] = scala.None,
  /* Source peer id */
  @named("from") from: Long,
  /* Destination peer id */
  @named("to") to: Long,
  /* If `true` transfer is a synchronization of a replicas If `false` transfer is a moving of a shard from one peer to another */
  @named("sync") sync: Boolean,
  @named("method") method: Option[ShardTransferMethod] = scala.None,
...
object ShardTransferInfoEnums:
end ShardTransferInfoEnums
