...
case class CreateShardingKey(
  @named("shard_key") shardKey: ShardKey,
  /* How many shards to create for this key If not specified, will use the default value from config */
  @named("shards_number") shardsNumber: Option[Int] = scala.None,
  ...
  @named("placement") placement: Option[Seq[Long]] = scala.None,
  @named("initial_state") initialState: Option[ReplicaState] = scala.None
)

object CreateShardingKeyEnums:
end CreateShardingKeyEnums
