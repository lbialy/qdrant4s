...
object SparseIndexType:
  import com.github.plokhotnyuk.jsoniter_scala.macros.*
  import com.github.plokhotnyuk.jsoniter_scala.core.*
  given sparseIndexTypeCodec: JsonValueCodec[SparseIndexType] = JsonCodecMaker.make {
    CodecMakerConfig
      .withAdtLeafClassNameMapper { x =>
        JsonCodecMaker.simpleClassName(x) match
          case "MutableRam" => "MutableRam"
          case "ImmutableRam" => "ImmutableRam"
          case "Mmap" => "Mmap"
      }
