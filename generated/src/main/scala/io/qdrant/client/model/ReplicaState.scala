...
object ReplicaState:
  ...
  given replicaStateCodec: JsonValueCodec[ReplicaState] = JsonCodecMaker.make {
    CodecMakerConfig
      .withAdtLeafClassNameMapper { x =>
        JsonCodecMaker.simpleClassName(x) match
          ...
          case "PartialSnapshot" => "PartialSnapshot"
          case "Recovery" => "Recovery"
          case "Resharding" => "Resharding"
          case "ReshardingScaleDown" => "ReshardingScaleDown"
          case "ActiveRead" => "ActiveRead"
