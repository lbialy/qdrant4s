...
case class CollectionParams(
  ...
  @named("read_fan_out_factor") readFanOutFactor: Option[Int] = scala.None,
  ...
  @named("read_fan_out_delay_ms") readFanOutDelayMs: Option[Long] = scala.None,
...
object CollectionParamsEnums:
end CollectionParamsEnums
