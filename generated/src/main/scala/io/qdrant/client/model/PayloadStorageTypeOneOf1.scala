...
case class PayloadStorageTypeOneOf1(
  @named("type") `type`: PayloadStorageTypeOneOf1Enums.Type
)

object PayloadStorageTypeOneOf1Enums:
  enum Type:
    case `on_disk`
...
end PayloadStorageTypeOneOf1Enums
