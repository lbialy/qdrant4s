...
case class PayloadStorageTypeOneOf(
  @named("type") `type`: PayloadStorageTypeOneOfEnums.Type
)

object PayloadStorageTypeOneOfEnums:
  enum Type:
    case `in_memory`
...
end PayloadStorageTypeOneOfEnums
