...
case class SearchParams(
  ...
  @named("hnsw_ef") hnswEf: Option[Int] = scala.None,
  /* Search without approximation. If set to true, search may run long but with exact results. */
  @named("exact") exact: Option[Boolean] = scala.None,
  @named("quantization") quantization: Option[QuantizationSearchParams] = scala.None,
  ...
  @named("indexed_only") indexedOnly: Option[Boolean] = scala.None,
  @named("acorn") acorn: Option[AcornSearchParams] = scala.None
)
