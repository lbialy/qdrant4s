...
case class OptimizationsResponse(
  @named("summary") summary: OptimizationsSummary,
  /* Currently running optimizations. */
  @named("running") running: Seq[Optimization],
  /* An estimated queue of pending optimizations. Requires `?with=queued`. */
  @named("queued") queued: Option[Seq[PendingOptimization]] = scala.None,
  /* Completed optimizations. Requires `?with=completed`. Limited by `?completed_limit=N`. */
  @named("completed") completed: Option[Seq[Optimization]] = scala.None,
  /* Segments that don't require optimization. Requires `?with=idle_segments`. */
  @named("idle_segments") idleSegments: Option[Seq[OptimizationSegmentInfo]] = scala.None
)
